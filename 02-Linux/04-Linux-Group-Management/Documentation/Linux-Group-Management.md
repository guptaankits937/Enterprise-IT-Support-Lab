...
- Verified Linux user and group information.
- Learned how Linux Group IDs (GIDs) identify groups.
- Created a new Linux group.
- Verified group creation using `getent`.
- Added an existing user to a supplementary group.
- Understood the purpose of the `usermod -aG` command.
- Learned the difference between primary and supplementary groups.
- Verified group membership using multiple commands.
- Removed a user's supplementary group access.
- Verified successful access revocation.
- Deleted a temporary Linux group.
- Performed verification after administrative changes.
- Understood the importance of cleanup after temporary access changes.
